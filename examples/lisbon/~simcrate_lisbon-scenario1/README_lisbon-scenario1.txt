...
I use every point to nearest destination for two main reasons: 1) use the previously created random points (I hope to re-run this simulation with real, anonymized data in the n# ~simcrate_lisbon-scenario1 
